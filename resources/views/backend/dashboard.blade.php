...
@section('content')
                    ...
                    <div class="tab nav-border" style="position: relative;">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="year" role="tabpanel" aria-labelledby="year-tab">
                                ...
                                <div class="row mb-30">
                                    <div class="col-md-2 col-sm-6">
                                        <img class="img-fluid" src="{{URL::asset('backend/assets/images/blog/06.jpg')}}" alt="">
                                    </div>
                                    <div class="col-md-6 col-sm-6">
    ...
    <div class="row">
                        ...
                        <li class="mb-20">
                            <div class="media">
                                <div class="position-relative">
                                    <img class="img-fluid mr-15 avatar-small" src="{{URL::asset('backend/assets/images/item/01.png')}}" alt="">
                                </div>
        ...
        <div class="col-xl-4 mb-30">
            <div class="card card-statistics h-100">
                <div class="p-4 text-center bg" style="background: url({{URL::asset('backend/assets/images/bg/01.jpg')}});">
